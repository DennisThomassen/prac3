    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form action="{{ route('tournaments.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="rounds" id="rounds" value="{{ old('rounds') }}" required
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                @error('rounds')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="text" name="teams_competing" id="teams_competing" value="{{ old('teams_competing') }}" required
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <input type="text" name="prize_amount" id="prize_amount" value="{{ old('prize_amount') }}" required
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                @error('prize_amount')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
