<nav x-data="{ open: false }" class="bg-gradient-to-r from-indigo-100 via-white to-blue-100 border-b border-gray-200 shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-gray-700 hover:bg-indigo-50 focus:outline-none focus:bg-indigo-50 focus:text-gray-700 transition duration-150 ease-in-out">
